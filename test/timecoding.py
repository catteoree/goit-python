...
datetime_5m = datetime.strptime("02/10/2021 23:59", "%d/%m/%Y %H:%M")
datetime_6m = datetime.strptime("11/10/2021 23:59", "%d/%m/%Y %H:%M")
datetime_7m = datetime.strptime("20/10/2021 23:59", "%d/%m/%Y %H:%M")
datetime_8m = datetime.strptime("21/10/2021 23:59", "%d/%m/%Y %H:%M")
datetime_9m = datetime.strptime("30/10/2021 23:59", "%d/%m/%Y %H:%M")
datetime_10m = datetime.strptime("08/11/2021 04:00", "%d/%m/%Y %H:%M")
datetime_11m = datetime.strptime("17/11/2021 22:00", "%d/%m/%Y %H:%M")
datetime_12m = datetime.strptime("18/11/2021 16:00", "%d/%m/%Y %H:%M")

writer_deadline_book001 = datetime.strptime("17/09/2021 23:59", "%d/%m/%Y %H:%M")
writer_deadline_book002 = datetime.strptime("18/09/2021 23:59", "%d/%m/%Y %H:%M")
writer_deadline_book01 = datetime.strptime("27/09/2021 23:59", "%d/%m/%Y %H:%M")
