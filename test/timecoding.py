...
datetime_6m = datetime.strptime("13/10/2021 14:00", "%d/%m/%Y %H:%M")
...
writer_deadline_book001 = datetime.strptime("22/10/2021 18:00", "%d/%m/%Y %H:%M")
writer_deadline_book002 = datetime.strptime("24/10/2021 18:00", "%d/%m/%Y %H:%M")
writer_deadline_book01 = datetime.strptime("12/11/2021 18:00", "%d/%m/%Y %H:%M")
writer_deadline_book02 = datetime.strptime("24/11/2021 18:00", "%d/%m/%Y %H:%M")
writer_deadline_book03 = datetime.strptime("19/12/2021 18:00", "%d/%m/%Y %H:%M")
writer_deadline_book04 = datetime.strptime("31/12/2021 18:00", "%d/%m/%Y %H:%M")
...
print(f"Deadline for 6 module completed on {datetime_6m}.")
