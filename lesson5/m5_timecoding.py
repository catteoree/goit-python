...
datetime_3m = datetime.strptime("19/08/2021 16:30", "%d/%m/%Y %H:%M")
datetime_4m = datetime.strptime("20/08/2021 00:00", "%d/%m/%Y %H:%M")
datetime_5m = datetime.strptime("20/08/2021 12:00", "%d/%m/%Y %H:%M")
datetime_6m = datetime.strptime("21/08/2021 00:00", "%d/%m/%Y %H:%M")
datetime_7m = datetime.strptime("21/08/2021 12:00", "%d/%m/%Y %H:%M")
datetime_8m = datetime.strptime("22/08/2021 00:00", "%d/%m/%Y %H:%M")
datetime_9m = datetime.strptime("22/08/2021 12:00", "%d/%m/%Y %H:%M")
datetime_10m = datetime.strptime("23/08/2021 00:00", "%d/%m/%Y %H:%M")
datetime_11m = datetime.strptime("23/08/2021 12:00", "%d/%m/%Y %H:%M")
...
print(f"Deadline for 2 module completed on 19/08/2021 06:00.")
