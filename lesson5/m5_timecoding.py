...
datetime_5m = datetime.strptime("22/08/2021 00:00", "%d/%m/%Y %H:%M")
datetime_6m = datetime.strptime("22/08/2021 10:00", "%d/%m/%Y %H:%M")
datetime_7m = datetime.strptime("22/08/2021 20:00", "%d/%m/%Y %H:%M")
datetime_8m = datetime.strptime("23/08/2021 06:00", "%d/%m/%Y %H:%M")
datetime_9m = datetime.strptime("23/08/2021 16:00", "%d/%m/%Y %H:%M")
datetime_10m = datetime.strptime("24/08/2021 02:00", "%d/%m/%Y %H:%M")
datetime_11m = datetime.strptime("25/08/2021 12:00", "%d/%m/%Y %H:%M")
datetime_12m = datetime.strptime("25/08/2021 22:00", "%d/%m/%Y %H:%M")
